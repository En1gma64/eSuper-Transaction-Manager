...
export default function RawTransactionForm(props) {
    ...
    const handleSubmit = (e) => {
        ...
        const url = Constants.API_URL_CREATE_RAW_TRANSACTION;
        ...
        props.onRawTransactionCreated(transactionToCreate);
    };

    return (
        <div>
            <form className="w-100 px-5" onSubmit={handleSubmit}>
                <h1 className="mt-5">Create New Raw Transaction</h1>
                ...
                <div className="mt-3">
                    ...
                    <button onClick={() => props.onRawTransactionCreated(null)} className="mx-2 btn btn-secondary">Cancel</button>
                </div>
            </form>
        </div>
    );
